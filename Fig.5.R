...
data <- forest_plot_subgroup_analysis_significant_AMR
...
pdf(file.path(workdir,"forest plot_subgroup analysis_significant_AMR.pdf"),  onefile=FALSE, width=8, height=5)
