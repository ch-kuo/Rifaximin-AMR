...
data <- forest_plot_subgroup_analysis_significant_SBP
...
pdf(file.path(workdir,"forest plot_subgroup analysis_significant_SBP.pdf"),  onefile=FALSE, width=8, height=5)
